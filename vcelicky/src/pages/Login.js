            ...
            >
                <VStack spacing={4} align='flex-start' w='full'>
                    ...
                    <FormControl>
                        ...
                        <Input rounder='none' variant='filled' placeholder='email@gmail.com'/>
                    </FormControl>
                    <FormControl>
                        <FormLabel>Password</FormLabel>
                        <Input rounder='none' variant='filled' type='password' placeholder='******'/>
                    </FormControl>
                    
                    <Button rounder='none' colorScheme='blue' width='365px'>Login</Button>
